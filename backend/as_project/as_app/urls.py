...
from .views.main_view import user_view, single_profile_view, category_view, single_category_view, product_view, single_product_view, brand_view, single_brand_view, add_to_cart_view, cart_view, update_item_quantity_view
...
urlpatterns = [
    ...
    path('cart/item/<int:item_id>/', update_item_quantity_view, name='update_item_quantity'),
]